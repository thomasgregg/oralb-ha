...
different 20-byte payload and is not decoded as this structure. Other
unregistered protocol versions also fail closed instead of being assumed
compatible with the newest known layout.
